...
export interface Faq { q: string; tags: string[]; read?: boolean; updated: string; steps: Step[]; service?: Service; }
...
export interface Category { id: string; name: string; icon: string; accent: 'blue' | 'magenta'; desc: string; manuals: Guide[]; }
